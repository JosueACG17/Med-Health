                ...
                <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
                    <div className="relative  mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
                        <div className="mt-3 text-center">
                            <h3 className="text-lg leading-6 font-bold text-gray-900">Animales Más Comúnes En La Terapia</h3>
                            <div className="mt-2 px-7 py-3 text-left">
                                <p className="text-sm font-semibold text-gray-800 text-justify mb-3">
                            ...
                            <div className="items-center px-4 py-3">
                                <button
                                    ...
                                    className="px-4 py-2 bg-blue-800 text-white text-base font-medium rounded-md w-full shadow-sm transition duration-500 hover:bg-black focus:outline-none focus:ring-2 focus:ring-gray-300"
                                >
                                    Cerrar
                                </button>
                            </div>
