      ...
      <div className="modal-container bg-white w-700 h-550 p-6 relative box-border overflow-hidden text-base">
        ...
        <div className="modal-content py-4 px-6">
          ...
          <div className="text-center mt-4">
            ...
            <h3 className="text-lg font-semibold text-indigo-900">{item.volumeInfo.authors}</h3>
            <h4 className="text-base font-bold text-gray-600">{item.volumeInfo.publisher}<span className="ml-2 text-gray-700">{item.volumeInfo.publishedDate}</span></h4>
