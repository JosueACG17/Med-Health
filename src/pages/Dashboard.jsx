...
const [profile, setProfile] = useState(JSON.parse(localStorage.getItem('userProfile')) || {});
  ...
  <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8">
    ...
    <div className="mt-8">
      <h1 className="text-2xl font-bold text-purple-550 sm:text-3xl">
        Bienvenido {profile.name}
      </h1>

      <p className="mt-1.5 text-sm text-gray-500">
      Aquí podrás encontrar información relevante sobre el desempeño de tu sitio, como los registros de la plataforma y mucho más. 
      </p>
    </div>
  </div>
</header>
