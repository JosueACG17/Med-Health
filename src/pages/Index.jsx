...
function Index() {
  return (
    <>
      <Header />
      <section
        class="relative bg-[url(https://media.istockphoto.com/id/1351480118/es/foto/inyecci%C3%B3n-de-un-m%C3%A9dico-usando-una-computadora-port%C3%A1til-durante-una-consulta-con-una-paciente.jpg?s=612x612&w=0&k=20&c=HWL88B7QPik82KuT9MyJpePRNOQSVYhqm_9-4kLrfGc=)] bg-cover bg-center bg-no-repeat opacity-95 h-96 z-[-1]"
      >
        <div
        ...
        <div
          class="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:h-screen lg:items-center lg:px-8"
        >
      ...
      <div>
        ...
        <div class="relative mx-auto max-w-8xl box bg">
          <div class="grid max-w-lg gap-8 mx-auto p-6 lg:grid-cols-4 lg:max-w-none pt-8">

            <div class="rounded-lg flex flex-col mb-12 overflow-hidden transition duration-200 ease-in-out shadow-2xl md:hover:-translate-y-6">
              <div class="flex-shrink-0">
                <img class="object-cover w-full h-48" src="https://media.istockphoto.com/id/1494761325/es/foto/datos-m%C3%A9dicos-e-informaci%C3%B3n-de-salud-un-m%C3%A9dico-con-una-tableta-toca-una-interfaz-virtual-de-la.jpg?s=612x612&w=0&k=20&c=m1k_MbLUyH0QsI0rMGWx_i4MtPo620_jUmlWMhFwQQw=" alt="" />
              </div>
              <div class="bg-white flex flex-col justify-between flex-1 p-2">
                <div class="flex-1">
                  <div class="block mt-2 space-y-6">
                    <h3 class="text-2xl font-semibold leading-none tracking-tighter text-black text-center">Servicios</h3>
                    <p class="text-lg font-normal text-gray-700 text-justify">
            ...
            <div class="rounded-lg flex flex-col mb-12 overflow-hidden transition duration-300 ease-in-out shadow-2xl md:hover:-translate-y-6">
              <div class="flex-shrink-0">
                <img class="object-cover w-full h-48" src="https://assets1.farmaciasanpablo.com.mx/landings/_blog/spf/nota-851-3.jpg" alt="" />
              </div>
              <div class="bg-white flex flex-col justify-between flex-1 p-2">
                <div class="flex-1">
                  <div class="block mt-2 space-y-6">
            ...
            <div class="rounded-lg flex flex-col mb-12 overflow-hidden transition duration-300 ease-in-out shadow-2xl md:hover:-translate-y-6">
              <div class="flex-shrink-0">
                <img class="object-cover w-full h-48" src="https://cba.ucb.edu.bo/wp-content/uploads/2020/03/virtual-biblioteca-1.jpg" alt="" />
              </div>
              <div class="bg-white flex flex-col justify-between flex-1 p-2">
                <div class="flex-1">
                  <div class="block mt-2 space-y-6">
                    <h3 class="text-2xl font-semibold leading-none tracking-tighter  text-black text-center">Información</h3>
                    <p class="text-lg font-normal text-justify text-gray-700">
            ...
            <div class="rounded-lg flex flex-col mb-12 overflow-hidden transition duration-300 ease-in-out shadow-2xl md:hover:-translate-y-6">
              <div class="flex-shrink-0">
                <img class="object-cover w-full h-48" src="https://media.istockphoto.com/id/1145739963/es/foto/moderno-edificio-blanco-de-hospital-p%C3%BAblico-sala-de-emergencias-entrada.jpg?s=612x612&w=0&k=20&c=RzVNfgYBFEotItGgOQMJaUYyrvCnh-B8jLppXy6M3eo=" alt="" />
              </div>
              <div class="bg-white flex flex-col justify-between flex-1 p-2">
                <div class="flex-1">
                  <div class="block mt-2 space-y-6">
                    <h3 class="text-2xl font-semibold leading-none tracking-tighter  text-black  text-center">Hospitales</h3>
                    <p class="text-lg font-normal text-justify text-gray-700">
      ...
      {/* Seccion */}
      <section >
        <div class="mx-8 pb-3 lg:px-8 mx-auto px-4 py-8 sm:px-6 lg:px-8">
          <div class="grid grid-cols-1 gap-4 md:grid-cols-2">

            <div class="bg-blue-700 p-8 md:p-12 lg:px-16 lg:py-24 rounded-lg">
              <div class="mx-auto max-w-xl text-center">
                ...
                <br></br>
                <h3 class="text-2xl font-bold text-white ">¿Qué puedes encontrar en Med-Health?</h3>
                <ul class="hidden text-white/90 sm:mt-4 sm:block text-justify icon-list">
        ...
        <div class="mx-8 px-4 pt-12 sm:px-6 sm:pt-22 lg:px-8 ">
          <div class="max-w-3xl">
            <h2 class="text-2xl font-bold sm:text-3xl text-justify ">
              Gracias por visitar Med-Health. Estás a punto de adentrarte en un viaje de descubrimiento.
            </h2>
          </div>

          <div class="mt-8 grid gap-8 lg:grid-cols-2 cont">
            <div class="h-4/6 flex flex-wrap">
              <div class="flex flex-wrap md:-m-2 m-1 h-112">
                <div class="flex flex-wrap h-4/6">
                  <div class="md:p-2 p-1 w-1/2 h-1/3">
                    <img alt="gallery" class="w-full object-cover h-full object-center block rounded-lg" src="https://th.bing.com/th/id/OIG.hQA7FKFM7u_kQeSn_b_A?pid=ImgGn" />
                  </div>
                  <div class="md:p-2 p-1 w-1/2 h-1/3">
                    <img alt="gallery" class="w-full object-cover h-full object-center block rounded-lg" src="https://th.bing.com/th/id/OIG.o5_MjcAC1M_VHq8qiu.2?pid=ImgGn" />
                  </div>
                  <div class="md:p-2 p-1 ">
                    <img alt="gallery" class="w-full h-1/2 object-cover object-center block rounded-lg" src="https://th.bing.com/th/id/OIG.SMBUYR8pBWq1LppYAjhm?pid=ImgGn&w=1024&h=1024&rs=1" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="h-4/6">
              <article class="space-y-2 text-gray-800">
              ...
              <article class="flex bg-white transition hover:shadow-xl mt-6">
                ...
                <div class="flex flex-1 flex-col justify-between border-2 border-blue-800">
                  <div class="p-4 sm:border-l-transparent sm:p-6">
                    ...
                    <p class="mt-2 line-clamp-3 text-sm/relaxed text-gray-800 ">
                  ...
                  <div class="sm:flex sm:items-end sm:justify-end ">
                    <a
                      href="/servicios"
                      class="block bg-yellow-400 px-5 py-3 text-center text-xs font-bold uppercase text-gray-900 transition hover:bg-yellow-700"
                    >
                      Comencemos
                    </a>
                  </div>
        ...
        {/*Seccion de bloques*/}
        <div class=" text-black font-bold mb-16 ">
          <div
            class="mx-auto max-w-full mr-1 ml-1 px-4 sm:py-18 sm:px-6 lg:py-14 lg:px-8"
          >
            <div class="mx-auto max-w-lg text-center">
              <h1
                class="bg-gradient-to-r from-green-700 via-blue-600 to-purple-600 bg-clip-text text-3xl font-extrabold text-transparent sm:text-5xl"
              >
                Conoce Más
              </h1>

              <p class="mt-4 text-black font-medium text-justify">
            ...
            <div class="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
              <a
               class="bloque block rounded-xl border-4 border-blue-900 p-8 shadow-xl transition hover:border-black"
                href="/servicios"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-10 w-10 text-purple-700 "
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
                ...
                <h2 class="mt-4 text-xl font-bold text-black  text-center">Servicios</h2>

                <p class="mt-3 text-sm font-medium text-black  text-justify">
              ...
              >
                ...
                <h2 class="mt-4 text-xl font-bold text-black  text-center">Información Médica</h2>
              ...
              >
                ...
                <h2 class="mt-4 text-xl font-bold text-black  text-center">Hospitales</h2>
              ...
              >
                ...
                <h2 class="mt-4 text-xl font-bold text-black  text-center">Medicina</h2>
