...
function Index(){
    return(
        ...
        <Header />
        <section
  class="relative bg-[url(https://media.istockphoto.com/id/1351480118/es/foto/inyecci%C3%B3n-de-un-m%C3%A9dico-usando-una-computadora-port%C3%A1til-durante-una-consulta-con-una-paciente.jpg?s=612x612&w=0&k=20&c=HWL88B7QPik82KuT9MyJpePRNOQSVYhqm_9-4kLrfGc=)] bg-cover bg-center bg-no-repeat h-96 z-[-1]"
>
  <div
...
<div>
  ...
  <div class="relative mx-auto max-w-8xl box">
    <div class="grid max-w-lg gap-8 mx-auto p-6 lg:grid-cols-4 lg:max-w-none pt-8">
        ...
        <div class="bg-white flex flex-col justify-between flex-1 p-2">
          <div class="flex-1">
            <div class="block mt-2 space-y-6">
              <h3 class="text-2xl font-semibold leading-none tracking-tighter text-neutral-600">Servicios</h3>
      ...
      <div class="rounded-lg flex flex-col mb-12 overflow-hidden transition duration-300 ease-in-out shadow-2xl md:hover:-translate-y-6">        
        ...
        <div class="bg-white flex flex-col justify-between flex-1 p-2">          
          <div class="flex-1">
            <div class="block mt-2 space-y-6">
              <h3 class="text-2xl font-semibold leading-none tracking-tighter text-neutral-600">Medicamentos</h3>
              <p class="text-lg font-normal text-gray-500">
      ...
      <div class="rounded-lg flex flex-col mb-12 overflow-hidden transition duration-300 ease-in-out shadow-2xl md:hover:-translate-y-6">   
        ...
        <div class="bg-white flex flex-col justify-between flex-1 p-2">        
          <div class="flex-1">
            <div class="block mt-2 space-y-6">
              <h3 class="text-2xl font-semibold leading-none tracking-tighter text-neutral-600">Información</h3>
              <p class="text-lg font-normal text-gray-500">
      ...
      <div class="rounded-lg flex flex-col mb-12 overflow-hidden transition duration-300 ease-in-out shadow-2xl md:hover:-translate-y-6">      
        ...
        <div class="bg-white flex flex-col justify-between flex-1 p-2">        
          <div class="flex-1">
            <div class="block mt-2 space-y-6">
              <h3 class="text-2xl font-semibold leading-none tracking-tighter text-neutral-600">Hospitales</h3>
              <p class="text-lg font-normal text-gray-500">
...
<div class="mx-8 pb-3 lg:px-8 mx-auto px-4 py-8 sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
      ...
      <div class="bg-blue-600 p-8 md:p-12 lg:px-16 lg:py-24 rounded-lg">
        <div class="mx-auto max-w-xl text-center">
          ...
          <ul class="hidden text-white/90 sm:mt-4 sm:block">
    ...
    <div class="flex flex-wrap md:-m-2 m-1 h-112">
      ...
      <div class="h-4/6">
        <article class="space-y-4 text-gray-600">
          ...
          Te ofrecemos contenido basado en la evidencia, escrito por expertos en salud y profesionales médicos. 
          Estamos aquí para desmitificar conceptos complejos, responder tus preguntas y brindarte orientación confiable.
          </p>
        </article>

  <article class="flex bg-white transition hover:shadow-xl mt-16">
  ...
  <div class="flex flex-1 flex-col justify-between">
    ...
    {/*Seccion de bloques*/}
  <div class="color text-white mb-16">
  <div
    class="mx-auto max-w-full px-4 py-8 sm:py-12 sm:px-6 lg:py-16 lg:px-8"
  >
    <div class="mx-auto max-w-lg text-center">
      <h2 class="text-3xl font-bold sm:text-4xl">Conoce más</h2>
    ...
    <div class="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
      <a
        class="bloque block rounded-xl border-2 border-purple-800 p-8 shadow-xl transition hover:border-pink-700/10 hover:shadow-pink-500/10"
      ...
      >
        ...
        <h2 class="mt-4 text-xl font-bold text-white">Servicios</h2>
        ...
        los usuarios pueden conectarse con profesionales de la salud y obtener el apoyo que necesitan, sin importar dónde se encuentren.
        </p>
      </a>

      <a
        class="bloque block rounded-xl border-2 border-purple-800 p-8 shadow-xl transition hover:border-pink-500/10 hover:shadow-pink-500/10"
        href="/services/digital-campaigns"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <h2 class="mt-4 text-xl font-bold text-white">Información médica</h2>
      ...
      >
        ...
        <h2 class="mt-4 text-xl font-bold text-white">Hospitales disponibles</h2>
      ...
      >
        ...
        <h2 class="mt-4 text-xl font-bold text-white">Medicina</h2>
